...
final class InventorySet implements Inventory {
  ...
  public Iterator<Record> iterator(Comparator<Record> comparator) {
    // TODO
	  List<Record> ls = new ArrayList<Record>(_data.values());
	  Collections.sort(ls, comparator);
	  return Collections.unmodifiableCollection(ls).iterator();
  ...
  Map<Video,Record> clear() {
    // TODO
	  Map<Video,Record> prevI = _data;
	  Map<Video,Record> newI = new HashMap<Video, Record>();
	  _data = newI;
    return prevI;
  }
